...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  function () {
    return /******/ (function (modules) {
      ...
      /******/ /******/ return __webpack_require__(
        (__webpack_require__.s = "./build/index.js")
      );
      /******/
    })(
      /************************************************************************/
  ...
  \************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var manager_1 = __webpack_require__(
              /*! ./manager */ "./build/manager.js"
            );

            var socket_1 = __webpack_require__(
              /*! ./socket */ "./build/socket.js"
            );
            ...
            var socket_io_parser_1 = __webpack_require__(
              /*! socket.io-parser */ "./node_modules/socket.io-parser/dist/index.js"
            );
  ...
  \**************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var eio = __webpack_require__(
              /*! engine.io-client */ "./node_modules/engine.io-client/lib/index.js"
            );
            ...
            var bind = __webpack_require__(
              /*! component-bind */ "./node_modules/component-bind/index.js"
            );

            var Backoff = __webpack_require__(
              /*! backo2 */ "./node_modules/backo2/index.js"
            );
              ...
              _createClass(Manager, [
                ...
                },
                {
                  ...
                  value: function open(fn) {
                    ...
                    var errorSub = on_1.on(socket, "error", function (err) {
                      ...
                      _get(
                        _getPrototypeOf(Manager.prototype),
                        "emit",
                        _this2
                      ).call(_this2, "error", err);
                ...
                },
                {
                  ...
                  value: function onopen() {
                    ...
                    _get(_getPrototypeOf(Manager.prototype), "emit", this).call(
                      this,
                      "open"
                    ); // add new subs
                    ...
                    var socket = this.engine;
                    this.subs.push(
                      on_1.on(socket, "data", bind(this, "ondata"))
                    );
                    this.subs.push(
                      on_1.on(socket, "ping", bind(this, "onping"))
                    );
                    this.subs.push(
                      on_1.on(socket, "error", bind(this, "onerror"))
                    );
                    this.subs.push(
                      on_1.on(socket, "close", bind(this, "onclose"))
                    );
                    this.subs.push(
                      on_1.on(this.decoder, "decoded", bind(this, "ondecoded"))
                    );
                  },
                  /**
                   * Called upon a ping.
                        ...
                        self.open(function (err) {
                          if (err) {
                            ...
                            _get(
                              ...
                              "emit",
                              _this3
                            ).call(_this3, "reconnect_error", err);
                          } else {
              ...
              _createClass(Socket, [
                ...
                },
                {
                  ...
                  value: function onclose(reason) {
                    ...
                    _get(_getPrototypeOf(Socket.prototype), "emit", this).call(
                      this,
                      "disconnect",
                      reason
                    );
                  ...
                  value: function onpacket(packet) {
                    ...
                    switch (packet.type) {
                      ...
                      case socket_io_parser_1.PacketType.CONNECT_ERROR:
                        ...
                        _get(
                          _getPrototypeOf(Socket.prototype),
                          "emit",
                          this
                        ).call(this, "connect_error", err);
  ...
  \**********************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var parseuri = __webpack_require__(
              /*! parseuri */ "./node_modules/parseuri/index.js"
            );
  ...
  \****************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            var Socket = __webpack_require__(
              /*! ./socket */ "./node_modules/engine.io-client/lib/socket.js"
            );
            ...
            module.exports.Transport = __webpack_require__(
              /*! ./transport */ "./node_modules/engine.io-client/lib/transport.js"
            );
            module.exports.transports = __webpack_require__(
              /*! ./transports/index */ "./node_modules/engine.io-client/lib/transports/index.js"
            );
            module.exports.parser = __webpack_require__(
              /*! engine.io-parser */ "./node_modules/engine.io-parser/lib/index.js"
            );
  ...
  \***************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var XHR = __webpack_require__(
              /*! ./polling-xhr */ "./node_modules/engine.io-client/lib/transports/polling-xhr.js"
            );

            var JSONP = __webpack_require__(
              /*! ./polling-jsonp */ "./node_modules/engine.io-client/lib/transports/polling-jsonp.js"
            );

            var websocket = __webpack_require__(
              /*! ./websocket */ "./node_modules/engine.io-client/lib/transports/websocket.js"
            );
  ...
  \***********************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var Polling = __webpack_require__(
              /*! ./polling */ "./node_modules/engine.io-client/lib/transports/polling.js"
            );

            var globalThis = __webpack_require__(
              /*! ../globalThis */ "./node_modules/engine.io-client/lib/globalThis.browser.js"
            );
              ...
              _createClass(JSONPPolling, [
                {
                  ...
                  value: function doClose() {
                    ...
                    _get(
                      _getPrototypeOf(JSONPPolling.prototype),
                      "doClose",
                      this
                    ).call(this);
                  },
  ...
  \*********************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var _require = __webpack_require__(
                /*! ../util */ "./node_modules/engine.io-client/lib/util.js"
              ),
              pick = _require.pick;
  ...
  \*****************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var yeast = __webpack_require__(
              /*! yeast */ "./node_modules/yeast/index.js"
            );
                ...
                },
                {
                  ...
                  value: function onData(data) {
                    ...
                    parser
                      ...
                      .forEach(callback); // if an event did not trigger closing
  ...
  \*******************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var _require2 = __webpack_require__(
                /*! ./websocket-constructor */ "./node_modules/engine.io-client/lib/transports/websocket-constructor.browser.js"
              ),
            ...
            var debug = __webpack_require__(
              /*! debug */ "./node_modules/debug/src/browser.js"
            )("engine.io-client:websocket"); // detect ReactNative environment
  ...
  \*************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var hasCORS = __webpack_require__(
              /*! has-cors */ "./node_modules/has-cors/index.js"
            );
  ...
  \*******************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            var _require = __webpack_require__(
                /*! ./commons */ "./node_modules/engine.io-parser/lib/commons.js"
              ),
            ...
            var decodePacket = function decodePacket(
              encodedPacket,
              binaryType
            ) {
            ...
            var decodeBase64Packet = function decodeBase64Packet(
              data,
              binaryType
            ) {
              if (base64decoder) {
  ...
  \*******************************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var encodeBlobAsBase64 = function encodeBlobAsBase64(
              data,
              callback
            ) {
  ...
  \****************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            var encodePacket = __webpack_require__(
              /*! ./encodePacket */ "./node_modules/engine.io-parser/lib/encodePacket.browser.js"
            );

            var decodePacket = __webpack_require__(
              /*! ./decodePacket */ "./node_modules/engine.io-parser/lib/decodePacket.browser.js"
            );
            ...
            var decodePayload = function decodePayload(
              encodedPayload,
              binaryType
            ) {
  ...
  \*****************************************************/
          ...
          /***/ function (module, exports, __webpack_require__) {
            ...
            var binary_1 = __webpack_require__(
              /*! ./binary */ "./node_modules/socket.io-parser/dist/binary.js"
            );
              ...
              _createClass(BinaryReconstructor, [
                {
                  ...
                  value: function takeBinaryData(binData) {
                    ...
                    if (this.buffers.length === this.reconPack.attachments) {
                      ...
                      var packet = binary_1.reconstructPacket(
                        this.reconPack,
                        this.buffers
                      );
